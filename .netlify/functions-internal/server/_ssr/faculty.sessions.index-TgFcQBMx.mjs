...
import { u as useApp, B as BRANCHES } from "./router-CzkqOVHL.mjs";
...
function SessionsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl space-y-5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 md:grid-cols-2 lg:grid-cols-3", children: [
      ...
      sorted.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 lg:col-span-3 rounded-2xl border border-dashed border-border p-12 text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 font-medium", children: "No sessions yet" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Create your first attendance session to get started." })
      ] })
    ] }),
