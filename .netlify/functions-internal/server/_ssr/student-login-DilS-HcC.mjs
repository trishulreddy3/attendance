...
import { u as useApp, A as AuthShell } from "./router-CzkqOVHL.mjs";
...
function StudentLoginPage() {
  ...
  const [studentId, setStudentId] = reactExports.useState("S101");
  const [email, setEmail] = reactExports.useState("rahul@college.edu");
  const [password, setPassword] = reactExports.useState("student123");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.form, { onSubmit: submit, initial: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-[11px] text-muted-foreground", children: "Demo: S101 · rahul@college.edu · student123" })
  ] }) });
}
export {
