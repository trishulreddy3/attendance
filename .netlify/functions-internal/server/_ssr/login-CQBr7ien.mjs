...
import { L as Logo, u as useApp } from "./router-CzkqOVHL.mjs";
...
function LoginPage() {
  ...
  const [email, setEmail] = reactExports.useState("anika@college.edu");
  const [password, setPassword] = reactExports.useState("demo1234");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.form, { onSubmit: submit, initial: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => toast("Reset link sent (demo)"), className: "text-primary hover:underline", children: "Forgot password?" })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-xs text-muted-foreground", children: [
      "New here? ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/signup", className: "text-primary hover:underline", children: "Create a faculty account" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-xs text-muted-foreground", children: [
      "Student? ",
