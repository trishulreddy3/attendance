...
import { u as useApp, L as Logo } from "./router-CzkqOVHL.mjs";
import "../_libs/sonner.mjs";
import { A as ArrowRight, h as Sparkles, Q as QrCode, i as ShieldCheck, j as CircleCheck } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "mx-auto flex max-w-6xl items-center justify-between px-6 py-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex items-center gap-2 text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/student-login", className: "rounded-md px-3 py-2 text-muted-foreground hover:text-foreground", children: "Student" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/signup", className: "inline-flex items-center gap-1.5 rounded-md bg-primary px-3.5 py-2 text-primary-foreground hover:opacity-90", children: [
          "Get started ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "mx-auto max-w-6xl px-6 pb-24 pt-10 md:pt-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-7 flex flex-wrap items-center justify-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/signup", className: "inline-flex items-center gap-1.5 rounded-lg bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground hover:opacity-90", children: [
            "Start as Faculty ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-3 text-xs text-muted-foreground", children: [
          "Demo faculty: ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: "anika@college.edu" }),
          " / ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: "demo1234" })
        ] })
      ] }),
