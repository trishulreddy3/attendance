...
import { b as api } from "./router-3KK7MBxu.mjs";
import "../_libs/sonner.mjs";
import { v as Server, c as Users, G as GraduationCap, R as Radio, j as CircleCheck, s as Activity, r as UserPlus, w as Ellipsis, n as TrendingUp } from "../_libs/lucide-react.mjs";
...
function AnimatedStatCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -right-6 -top-6 text-primary/5 transition-transform duration-500 group-hover:scale-110 group-hover:-rotate-12", children: icon }),
...
function AdminDashboard() {
  ...
  const activityData = [{
    name: "Mon",
    attendance: Math.floor(data.totalAttendance * 0.1)
  }, {
    name: "Tue",
    attendance: Math.floor(data.totalAttendance * 0.15)
  }, {
    name: "Wed",
    attendance: Math.floor(data.totalAttendance * 0.12)
  }, {
    name: "Thu",
    attendance: Math.floor(data.totalAttendance * 0.2)
  }, {
    name: "Fri",
    attendance: Math.floor(data.totalAttendance * 0.18)
  }, {
    name: "Sat",
    attendance: Math.floor(data.totalAttendance * 0.05)
  }, {
    name: "Sun",
    attendance: Math.floor(data.totalAttendance * 0.02)
  }];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 sm:p-8 max-w-[1600px] mx-auto space-y-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 sm:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedStatCard, { title: "Total Faculty", value: data.totalFaculty, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "size-full" }), delay: 0.1, trend: "+2 this week", description: "Active teaching staff accounts" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedStatCard, { title: "Total Students", value: data.totalStudents, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "size-full" }), delay: 0.2, trend: "+15 this week", description: "Registered student devices" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedStatCard, { title: "Active Sessions", value: data.totalSessions, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { className: "size-full" }), delay: 0.3, trend: "Live now", description: "Total attendance sessions created" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedStatCard, { title: "Total Pings", value: data.totalAttendance, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "size-full" }), delay: 0.4, trend: "+1.2k today", description: "Successful attendance marks recorded" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Number of attendances marked per day (Simulated)" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[300px] w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: activityData, margin: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "attendance", fill: "var(--primary)", radius: [4, 4, 0, 0], maxBarSize: 50 })
        ] }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        opacity: 0,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between p-6 border-b border-border/50 gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "inline-flex h-9 items-center justify-center rounded-lg bg-primary px-4 text-sm font-medium text-primary-foreground transition-colors hover:opacity-90", children: [
