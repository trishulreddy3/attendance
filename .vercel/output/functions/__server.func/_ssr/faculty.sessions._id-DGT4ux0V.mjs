...
import { u as useApp } from "./router-CTeEyVFc.mjs";
import { f as fmtTime } from "./format-DWYTrrSZ.mjs";
import "../_libs/sonner.mjs";
import { A as ArrowLeft, Z as RefreshCcw, U as Users, c as CircleCheck } from "../_libs/lucide-react.mjs";
...
function LiveSession() {
  ...
  const [terminating, setTerminating] = reactExports.useState(false);
  const isRefreshing = reactExports.useRef(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5 flex items-center justify-between", children: [
      ...
      isEnded ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex items-center gap-1.5 rounded-full bg-muted px-2.5 py-1 text-xs font-medium text-muted-foreground", children: "Ended" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 rounded-full bg-success/10 px-2.5 py-1 text-xs font-medium text-success", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-wider text-muted-foreground", children: isEnded ? "Status" : "Ends in" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-semibold tabular-nums tracking-tight", children: isEnded ? "Ended" : remaining })
          ] })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex items-center justify-between text-xs text-muted-foreground", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            !isEnded && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { disabled: terminating, onClick: async () => {
              setTerminating(true);
              try {
            ...
            }, className: "inline-flex items-center gap-1 rounded-md border border-destructive/20 bg-destructive/10 text-destructive px-2.5 py-1 hover:bg-destructive/20 disabled:opacity-50", children: terminating ? "Ending..." : "End Session" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { disabled: isEnded || isRefreshing.current, onClick: async () => {
            ...
            }, className: "inline-flex items-center gap-1 rounded-md border border-border bg-card px-2.5 py-1 hover:bg-accent disabled:opacity-50", children: [
