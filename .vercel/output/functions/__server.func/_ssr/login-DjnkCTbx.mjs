...
import { L as Logo, u as useApp } from "./router-CTeEyVFc.mjs";
import { m as motion } from "../_libs/framer-motion.mjs";
import { g as Mail, h as EyeOff, E as Eye, i as Lock } from "../_libs/lucide-react.mjs";
...
function LoginPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.form, { onSubmit: submit, initial: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-xs text-muted-foreground", children: [
      ...
      " | ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/admin-login", className: "text-foreground hover:underline", children: "Admin Login" })
    ] })
  ] }) });
}
function AuthShell({
