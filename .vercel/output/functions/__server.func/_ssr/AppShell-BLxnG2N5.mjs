...
import { f as useLocation, e as useNavigate, L as Link } from "../_libs/tanstack__react-router.mjs";
import { a as useTheme, u as useApp, L as Logo } from "./router-CTeEyVFc.mjs";
import { c as cn } from "./utils-H80jjgLf.mjs";
import { m as motion, A as AnimatePresence } from "../_libs/framer-motion.mjs";
import { p as LogOut, X, q as Menu, r as Sun, s as Moon } from "../_libs/lucide-react.mjs";
function AppShell({
  nav,
  children,
  title
  ...
  const Sidebar = /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "flex h-full w-64 flex-col border-r border-sidebar-border bg-sidebar", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-sidebar-border p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 rounded-lg px-2 py-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid size-8 place-items-center rounded-full bg-primary/15 text-primary text-xs font-semibold", children: isAdmin ? "A" : me?.name?.[0] ?? "U" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate text-sm font-medium", children: isAdmin ? "Administrator" : me?.name ?? "User" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate text-xs text-muted-foreground", children: isAdmin ? "admin@system" : me?.email })
      ] }),
