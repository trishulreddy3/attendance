...
import { u as useApp, B as BRANCHES } from "./router-CTeEyVFc.mjs";
import { t as toLocalInput, d as durationLabel, a as fmtDate, f as fmtTime } from "./format-DWYTrrSZ.mjs";
import { P as Plus, C as Calendar, Y as Clock, Q as QrCode, L as LoaderCircle } from "../_libs/lucide-react.mjs";
...
function SessionsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl space-y-5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { open, onClose: loading ? () => {
    } : () => setOpen(false), title: "New attendance session", width: 560, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: submit, className: "space-y-4 relative", children: [
      loading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 z-10 flex flex-col items-center justify-center gap-3 rounded-xl bg-card/80 backdrop-blur-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "size-8 animate-spin text-primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-muted-foreground", children: "Creating session…" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("fieldset", { disabled: loading, className: "contents", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2 pt-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "submit", disabled: loading, className: "inline-flex items-center gap-1.5 rounded-lg bg-primary px-3.5 py-2 text-sm font-medium text-primary-foreground hover:opacity-90 disabled:opacity-50", children: [
            loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "size-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(QrCode, { className: "size-4" }),
            " ",
