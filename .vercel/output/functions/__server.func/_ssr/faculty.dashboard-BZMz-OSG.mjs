...
import { U as Users, m as Radio, c as CircleCheck, y as TrendingUp, K as Activity } from "../_libs/lucide-react.mjs";
...
function Dashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Total Students", value: d.totalStudents, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "size-4" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Active Sessions", value: d.activeSessions, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Radio, { className: "size-4" }), delay: 0.05, hint: d.activeSessions ? "Live now" : "None active" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Present Today", value: d.presentToday, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "size-4" }), delay: 0.1 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Attendance Rate", value: d.attendanceRate, suffix: "%", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "size-4" }), delay: 0.15 })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 h-64 relative", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AreaChart, { data: d.last7Days, margin: {
            left: -20,
            right: 8,
            top: 8
          }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        delay: 0.25
      }, className: "rounded-2xl border border-border bg-card p-5 relative overflow-hidden", children: [
        !data && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 z-10 flex items-center justify-center bg-card/50 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-6 rounded-full border-2 border-primary border-t-transparent animate-spin" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 space-y-3", children: [
          data && d.recentActivity.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No activity yet — start a session." }),
          d.recentActivity.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.li, { initial: {
            opacity: 0,
            x: -6
          }, animate: {
            opacity: 1,
