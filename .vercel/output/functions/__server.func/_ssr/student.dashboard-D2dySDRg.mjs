...
import { u as useApp, b as api } from "./router-CTeEyVFc.mjs";
import { a as fmtDate, f as fmtTime } from "./format-DWYTrrSZ.mjs";
import "../_libs/sonner.mjs";
import { m as motion } from "../_libs/framer-motion.mjs";
import { B as BookOpen, c as CircleCheck, b as CircleX, y as TrendingUp, k as ScanLine } from "../_libs/lucide-react.mjs";
...
function StudentDashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Total Classes", value: d.totalClasses, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "size-4" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Present", value: d.present, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "size-4" }), delay: 0.05 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Absent", value: d.absent, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { className: "size-4" }), delay: 0.1 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Attendance %", value: d.attendancePct, suffix: "%", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "size-4" }), delay: 0.15 })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 grid place-items-center py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative grid place-items-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-semibold tracking-tight", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedCounter, { value: d.attendancePct, suffix: "%" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 h-56 relative", children: [
          !data && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 z-10 flex items-center justify-center bg-card/50 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-6 rounded-full border-2 border-primary border-t-transparent animate-spin" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data: d.last7Days, margin: {
            left: -20,
            top: 8
          }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "divide-y divide-border relative", children: [
        !data && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 z-10 flex items-center justify-center bg-card/50 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-6 rounded-full border-2 border-primary border-t-transparent animate-spin" }) }),
        data && d.recentAttendance.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "px-5 py-10 text-center text-sm text-muted-foreground", children: "No attendance yet — scan a QR to begin." }),
        d.recentAttendance.map((s, i) => {
